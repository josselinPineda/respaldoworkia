...
/// Screen that shows activities for a job assignment and allows registering new ones.
class JobActivitiesScreen extends StatefulWidget {
  const JobActivitiesScreen({
    super.key,
  ...
  /// Job assignment to show and register activities for.
  final TrabajoAsignado asignacion;

  /// Original job title for AppBar.
  ...
  /// Technician ID for filtering (optional).
  final String? technicianId;

  /// Technician name for title (optional).
  final String? technicianName;

  @override
  State<JobActivitiesScreen> createState() => _JobActivitiesScreenState();
}

class _JobActivitiesScreenState extends State<JobActivitiesScreen> {
  @override
  void initState() {
    super.initState();
    // Load activities for current assignment.
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      // Ensure users loaded for technician name.
    ...
    return Scaffold(
      ...
      body: Consumer<ActividadesViewModel>(
        builder: (context, actividadesVM, _) {
          ...
          // Filter by technician if ID provided
